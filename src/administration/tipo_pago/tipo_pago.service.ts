...
export class TipoPagoService {
  ...
  async findAll(
    ...
    const queryBuilder = await this.tipoPagoRepository.createQueryBuilder('tp');
  ...
  async findOne(tpaCodigo: number): Promise<TipoPago> {
  ...
  async update(tpaCodigo: number, updateTipoPagoDto: UpdateTipoPagoDto) {
    let queryRunner: QueryRunner;
    try {
