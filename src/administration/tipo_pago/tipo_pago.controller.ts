...
export class TipoPagoController {
  ...
  findOne(@Param('tpaCodigo', ParseIntPipe) tpaCodigo: number) {
  ...
  update(@Param('tpaCodigo', ParseIntPipe) tpaCodigo: number, @Body() updateTipoPagoDto: UpdateTipoPagoDto) {
  ...
  remove(@Param('tpaCodigo', ParseIntPipe) tpaCodigo: number) {
